...
ngx_core_module_init_conf(ngx_cycle_t *cycle, void *conf)
{
    ...
    /* RG: Skipping all the user crapola */
...
{
    ngx_write_stderr("ngx_set_user" NGX_LINEFEED);
#if (NGX_WIN32)
    ...
    ngx_log_stderr(0, "ccf->username: %s", ccf->username);
    ngx_log_stderr(0, "cf->name: %s\n", cf->name);
